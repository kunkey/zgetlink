...
window.jwplayer = function(t) {
	...
	var r = "8.20.1+commercial_v8-20-1.454.commercial.a14c3fc.hlsjs..hlsjsalt..jwplayer..dai.ee04c20.freewheel.f907d3d.googima.9b4d0c6.googimanvmp.106f6b4.headerbidding.a753978.vast.9453e33.analytics.920ae01.gapro.141397a"
}, function(t, e, n) {
	"use strict";
	var r = n(0),
		i = n(18),
			...
			var e = t.el,
				...
				h = function(n) {
					if (clearTimeout(c), t.el)
						...
						}(t, n, o), o ? x(t, i.o, n) : (x(t, i.ub, n), "touchend" !== n.type || p || S(n))
					}
				};
	...
	var y = {
		...
		over: function(t) {
			(f || d) && w(t, i.ab, f ? "pointerover" : "mouseover", (function(e) {
		...
		out: function(t) {
			...
			} else d && w(t, i.Z, "mouseout", (function(e) {
				x(t, i.Z, e)
			}))
		},
		move: function(t) {
			(f || d) && w(t, i.X, f ? "pointermove" : "mousemove", (function(e) {
	...
	Object(r.j)(nt, U), L(nt), "function" == typeof et.define && et.define.amd && et.define([], (function() {
		return nt
	}));
	var rt = nt;
	...
	function m(t, e) {
		var n = "file:" === window.location.protocol ? "https:" : "",
			r = {
				bidding: "/player/bidding.js",
				jwpsrv: "/player/jwpsrv.js",
				dai: "/player/dai.js",
				vast: "/player/vast.js",
				googima: e ? "/player/googimanvmp.js" : "/player/googima.js",
				freewheel: "/player/freewheel.js",
				gapro: "/player/gapro.js"
			} [t];
		return r ? n + r : ""
	}
	...
	function V(t) {
		return U(t) ? Promise.resolve() : R(t).then((function() {
	...
	var ct = function(t) {
		this._events = {}, this.modelShim = new et.a, this.modelShim._qoeItem = new K.a, this.mediaShim = {}, this.setup = new J(this.modelShim), this.currentContainer = this.originalContainer = t, this.apiQueue = new i.a(this, ["load", "play", "pause", "seek", "stop", "playlistItem", "playlistNext", "playlistPrev", "next", "preload", "setConfig", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality", "setFullscreen", "addButton", "removeButton", "castToggle", "setMute", "setVolume", "setPlaybackRate", "addCues", "setCues", "setPlaylistItem", "stopCasting", "resize", "setCaptions", "setControls"], (function() {
			return !0
		}))
	};
...
var jwDefaults = {
	...
	"displaytitle": true,
	"flashplayer": "//ssl.p.jwpcdn.com/player/v/8.20.1/jwplayer.flash.swf",
	"height": 360,
	"key": "F9v2BMNzDleHthA1mjYK+2n5ilusmo2p0N6gehtBm/I8p9ZLSH3V3w==",
	"mute": false,
	"ph": 1,
	"pid": "QpLbHLbV",
